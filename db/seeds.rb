...
event1 = Event.create!(title: 'Big Afeefa-Event', state: 'new', creator: user1)
event2 = Event.create!(title: 'Kuefa im AZ-Conni', state: 'new', creator: user1)
...
event5 = Event.create!(title: 'Sommerfest', parent_id: orga4, state: 'annotated', creator: user1)
event6 = Event.create!(title: 'Deutschkurs', parent_id: orga5, state: 'annotated', creator: user1)
