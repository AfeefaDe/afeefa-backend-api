...
event5 = Event.create(title: 'Sommerfest', parent_id: orga4, state: 'new')
event6 = Event.create(title: 'Deutschkurs', parent_id: orga5, state: 'edit_request')
event7 = Event.create(title: 'Kulturtreff', parent_id: orga5, state: 'new')
event8 = Event.create(title: 'Offenes Netzwerktreffen Dresden für Alle', parent_id: orga2)
