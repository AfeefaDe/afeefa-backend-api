...
orga4 = Orga.create!(title: 'Ausländerrat', state: 'inactive', parent_orga: orga1)
orga5 = Orga.create!(title: 'Frauentreff "Hand in Hand"', state: 'inactive', parent_orga: orga1)
Orga.create!(title: 'Integrations- und Ausländerbeauftragte', parent_orga: orga1)
Orga.create!(title: 'Übersetzer Deutsch-Englisch-Französisch', state: 'inactive', parent_orga: orga1)
Orga.create!(title: 'Interkultureller Frauentreff', parent_orga: orga4, state: 'inactive')
Orga.create!(title: 'Außenstelle Adlergasse', parent_orga: orga4, state: 'active')
...
event1 = Event.create!(title: 'Big Afeefa-Event', state: 'active', creator: user1)
event2 = Event.create!(title: 'Kuefa im AZ-Conni', state: 'active', creator: user1)
event3 = Event.create!(title: 'Playing Football', state: 'active', creator: user1)
event4 = Event.create!(title: 'Cooking for All', state: 'active', creator: user1)
event5 = Event.create!(title: 'Sommerfest', parent_id: orga4, state: 'inactive', creator: user1)
event6 = Event.create!(title: 'Deutschkurs', parent_id: orga5, state: 'inactive', creator: user1)
event7 = Event.create!(title: 'Kulturtreff', parent_id: orga5, state: 'inactive', creator: user1)
event8 = Event.create!(title: 'Offenes Netzwerktreffen Dresden für Alle', parent_id: orga2, state: 'inactive', creator: user1)
