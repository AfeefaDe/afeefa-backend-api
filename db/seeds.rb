...
event5 = Event.create(title: 'Sommerfest', parent_id: orga4)
event6 = Event.create(title: 'Deutschkurs', parent_id: orga5)
event7 = Event.create(title: 'Kulturtreff', parent_id: orga5)
