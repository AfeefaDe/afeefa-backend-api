...
class DataPlugins::Contact::V1::ContactsControllerTest < ActionController::TestCase
  ...
  test 'not create contact for owner with already existing contact' do
  ...
  test 'create contact with location_id and contact_persons' do
  ...
  test 'create contact with new location and contact_persons' do
    orga = create(:orga_without_contacts)
  ...
  test 'not update contact not owned by owner' do
  ...
  test 'not link not existing contact' do
  ...
  test 'link existing external contact' do
  ...
  test 'not link existing external contact if own contact given' do
  ...
  test 'update contact with location_id and without contact_persons' do
    orga = create(:orga)
    assert location = create(:afeefa_office)
  ...
  test 'update contact with new location and contact_persons' do
    orga = create(:orga)
  ...
  test 'update contact with update of existing location' do
  ...
  test 'not remove link and do not remove contact not linked and not owned by owner' do
    orga_editing = create(:orga, title: 'editor')
    orga_owning = create(:orga, title: 'owner')
    assert location = create(:afeefa_office)
    contact =
  ...
  test 'remove link but do not remove contact if not owned by owner' do
  ...
  test 'remove contact and including contact persons but not foreign location' do
    orga = create(:orga)
    assert location = DataPlugins::Location::Location.last
    contact = DataPlugins::Contact::Contact.create!(owner: orga, location: location, title: 'old title')
  ...
  test 'remove contact and including contact persons and owning location' do
    orga = create(:orga)
    assert location = DataPlugins::Location::Location.last
    contact = DataPlugins::Contact::Contact.create!(owner: orga, location: location, title: 'old title')
    location.update!(contact: contact)
  ...
  test 'remove linked location when removing contact with that location' do
    orga = create(:orga)
    assert location = DataPlugins::Location::Location.last
