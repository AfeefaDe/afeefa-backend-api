...
class Api::V1::OrgasControllerTest < ActionController::TestCase
  ...
  test 'get index' do
    ...
    assert_equal Orga.by_area(@controller.current_api_v1_user.area).count, json['data'].size
    assert_equal(
      Orga.last
  ...
  test 'deliver initiators with different detail granularity' do
  ...
  test 'not get show root_orga' do
    not_existing_id = 999
  ...
  test 'not allow to create orga with existing title' do
  ...
  test 'allow to create orga with existing title in other area' do
  ...
  test 'get show with resources' do
    @orga = create(:orga)
  ...
  test 'update should fail for invalid' do
    @orga = create(:orga)
  ...
  test 'update orga with nested attributes' do
    creator = create(:user)
  ...
  test 'deactivate an inactive invalid orga' do
  ...
  test 'deactivate an active invalid orga' do
    orga = create(:orga, title: 'foobar')
    orga.title = nil
  ...
  test 'destroy orga destroys contacts and locations' do
    @orga = create(:orga)
  ...
  test 'destroy orga moves linked contacts and locations to root orga' do
    @orga = create(:orga)
  ...
  test 'create new orga with parent relation and inheritance' do
    @orga = create(:orga)
  ...
  test 'create new orga with resources' do
    @orga = create(:orga)
